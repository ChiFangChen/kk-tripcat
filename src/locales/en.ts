const en = {
  ...
  shopping: {
    ...
    copiedToMyList: "Added to list",
    copiedFromMine: "Copied from my list",
    copyFailed: "Copy failed, please try again",
    syncFromCopy: "Sync",
    syncFromCopyHint: "Update mine to match their edited version",
    syncTitle: "Sync to their version",
    syncConfirm:
      "This overwrites your item's content and images with {{name}}'s edited version. Continue?",
    synced: "Synced",
    ...
    form: {
      ...
      privateHint: "Only you can see this; hidden from others",
      images: "Images",
